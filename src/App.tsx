...
function AppContent() {
  ...
  if (!userProfile) {
    return (
      <div className="min-h-screen bg-gray-50 p-6 flex flex-col items-center justify-center space-y-8">
        ...
        <ProfileForm 
          ...
          onComplete={() => {
            ...
            // The snapshot listener will update userProfile automatically
          }} 
